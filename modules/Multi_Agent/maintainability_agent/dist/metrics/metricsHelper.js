export function checkFunctionLength(method, realLoc) {
...
export function checkNestingDepth(method) {
...
export function checkComplexity(method) {
...
export function checkParameters(method) {
...
export function checkCommentRatio(method, realLoc, realComments) {
...
export function checkNamingClarity(method) {
...
export function evaluateAllMetrics(method, realStats) {
